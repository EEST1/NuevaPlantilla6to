...
# 1 "Primitivas/PR_EntradasDigitales.c"
...
# 52 "/opt/microchip/xc8/v2.10/pic/include/pic18f4550.h"
...
# 66 "Primitivas/PR_EntradasDigitales.c"
volatile uint8_t ED_BufferEntradas = 0 ;
...
if((uint8_t)((ED_BufferEntradas) & 0x01) && !antkey0)
{
antkey0 =! antkey0;

}
else if(!(uint8_t)((ED_BufferEntradas) & 0x01) && antkey0)
{
antkey0 =! antkey0;
}

if((uint8_t)((ED_BufferEntradas >> 1) & 0x01) && !antkey1)
{
antkey1 =! antkey1;

}
else if(!(uint8_t)((ED_BufferEntradas >> 1) & 0x01) && antkey1)
{
antkey1 =! antkey1;
}

if((uint8_t)((ED_BufferEntradas >> 2) & 0x01) && !antkey2)
{
antkey2 =! antkey2;

}
else if(!(uint8_t)((ED_BufferEntradas >> 2) & 0x01) && antkey2)
{
antkey2 =! antkey2;
}

if((uint8_t)((ED_BufferEntradas >> 3) & 0x01) && !antkey3)
{
antkey3 =! antkey3;

}
else if(!(uint8_t)((ED_BufferEntradas >> 3) & 0x01) && antkey3)
{
antkey3 =! antkey3;
}
