...
# 90 "inc/MacTimer.h"
extern volatile uint16_t MCTMR_Run[8];
extern volatile uint8_t MCTMR_Eventos ;

# 100
void MCTMR_Analizar (void);


void MCTMR_Start (uint8_t evento, uint8_t temp);
...
# 72 "Primitivas/PR_MacTimer.c"
volatile uint16_t MCTMR_Run[8];
volatile uint8_t MCTMR_Eventos = 0 ;
...
if(tiempo)
{
MCTMR_Run[evento] = tiempo;
MCTMR_Eventos &= ~(0x01 << evento);
}
else
{
MCTMR_Run[evento] = tiempo;
