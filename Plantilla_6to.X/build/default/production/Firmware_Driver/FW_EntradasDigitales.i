...
# 1 "Firmware_Driver/FW_EntradasDigitales.c"
...
# 66 "Firmware_Driver/FW_EntradasDigitales.c"
volatile uint8_t ED_Delay = 1;
...
static uint8_t contador_estados[4];


j = !PORTBbits.RB4;
j |= (uint8_t) (!PORTBbits.RB5 << (0x01));
j |= (uint8_t) (!PORTBbits.RB6 << (0x02));
j |= (uint8_t) (!PORTBbits.RB7 << (0x03));

cambios = ED_BufferEntradas ^ j ;
