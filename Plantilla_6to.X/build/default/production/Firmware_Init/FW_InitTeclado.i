...
# 1 "Firmware_Init/FW_InitTeclado.c"
...
# 61 "Firmware_Init/FW_InitTeclado.c"
volatile uint8_t TDO_fila = 0xFF;
volatile uint8_t TDO_col = 0xFF;
volatile uint8_t TDO_flag_kb = 0;
volatile uint8_t TDO_delay_kb = 0;
